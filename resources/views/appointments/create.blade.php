    ...
    @endif
        ...
        @csrf
            <div class="form-group">
                ...
                class="form-control" placeholder="Describe brevemente la consulta" 
                ...
                <div id="hours">
                    ...
                    @else    
                        <div class="alert alert-dark" role="alert">
                            Seleccione un médico para ver sus horas disponibles
                        </div>
                    @endif
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="custom-control custom-radio mb-3">
                    ...
                    @if(old('type') == 'Exámen') checked @endif value="Exámen">
